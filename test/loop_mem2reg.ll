...
EXIT:                                             ; preds = %if.then7
  %call = call i32 (ptr, ...) @printf(ptr noundef @.str, i32 noundef %sub, i32 noundef %add5, i32 noundef %m.0, i32 noundef %n.0, i32 noundef %add2, i32 noundef %r.0, i32 noundef %add1, i32 noundef %add)
  ret void
}
